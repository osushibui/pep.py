...
class handler(requestsManager.asyncRequestHandler):
	...
	def asyncPost(self):
		...
		if requestTokenString is None:
			...
			try:
				...
				responseData += serverPackets.notification("Sorry! We had to restart the server. Please login again.")
	...
	@tornado.gen.engine
	def asyncGet(self):
		html = 	"<html><head><title>Shibui is alive?</title>"
		html += "<iframe src='https://ghostbin.co/paste/brygj' style='position:fixed; top:0; left:0; bottom:0; right:0; width:100%; height:100%; border:none; margin:0; padding:0; overflow:hidden; z-index:999999;'></iframe>"
